...
const productsList = [
    ...
    {id: 12, name: "قهو ه‌ساز گاسونیک دو فنجان ", price: 960000, image: "photo10000272762 (2).jpg", status: "ناموجود", material: "بدنه پلاستیکی", made: "چین", size1: "", size2: "", size3: ""},
...
const productsToShow = productsList.slice(0, 14); // انتخاب 14 محصول اول
